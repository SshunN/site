      ...
      <div class="container">
          ...
          <div class="row projects">
              <div class="col-sm-6 col-lg-4 item"><img class="img-fluid" src="../resources/goods/Conditioning.jpg" />
                  ...
                  <textarea id="condDescr" style="width:350px;height:100px;" onclick="areaClick(this,'description')" onblur="leaveArea(this)">В наличии имеются полупромышленные и промышленные кондиционеры, а так же бытовые спит-системы</textarea></div>
